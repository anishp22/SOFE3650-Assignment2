...
public class CashRegister {
    ...
    public void updateInfo(){
        receipt.displayItem(String.format("Ticket Printer --> Name: %s, Price: %s, UPCCode: %s", productEntered.productName, productEntered.productPrice, productEntered.upcCode));
        screen.displayItem(String.format("Display Screen --> Name: %s, Price: %s, UPCCode: %s", productEntered.productName, productEntered.productPrice, productEntered.upcCode));
